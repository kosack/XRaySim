...
public:
	...
	inline Void		MakeUnit(Int i, TVReal k = vl_one);		// I[i]
	inline Void		MakeBlock(TVReal k = vl_one);			// All-k vector
...
inline Void TVec3::MakeUnit(Int n, TVReal k)
{
	if (n == 0)
...
inline Void TVec3::MakeZero()
{
	elt[0] = vl_zero; elt[1] = vl_zero; elt[2] = vl_zero;
}

inline Void TVec3::MakeBlock(TVReal k)
{
